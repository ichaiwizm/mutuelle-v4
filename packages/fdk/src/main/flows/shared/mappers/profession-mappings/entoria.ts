/**
 * Entoria platform profession mappings
 */

import { ENTORIA_DEFAULT_PROFESSION } from './constants';
import { createProfessionMapper } from './types';

/**
 * Entoria profession mappings - comprehensive list
 */
export const entoriaProfessionMap: Record<string, string> = {
  // Generic professions
...
/** Pre-built mapper for Entoria */
export const mapEntoriaProfession = createProfessionMapper(
