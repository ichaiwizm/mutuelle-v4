/**
 * Validateurs d'âge pour SwissLifeOne
 * Ranges: Principal (18-110), Conjoint (16-99), Enfants (0-27)
 */

/**
 * Calcule l'âge exact d'une personne
 * Prend en compte si l'anniversaire est déjà passé cette année
 */
...
/**
 * Valide l'âge d'une personne dans une plage donnée
 */
...
/**
 * Valide l'âge de l'assuré principal (18-110 ans)
 */
...
/**
 * Valide l'âge du conjoint (16-99 ans)
 * Note: SwissLife accepte les conjoints dès 16 ans (vs 18 pour Alptis)
 */
export function validateSpouseAge(birthDate: Date): boolean {
  return validateAge(birthDate, 16, 99);
}
